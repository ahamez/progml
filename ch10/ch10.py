...
def report(iteration, X_train, Y_train, X_test, Y_test, w1, w2):
    ...
    print("{:5d} - Loss {:.6f}, {:.2f}%".format(iteration, training_loss, accuracy))
...
w1, w2 = train(data.X_train, data.Y_train, data.X_test, data.Y_test, n_hidden_nodes=200, iterations=100, lr=0.01)
