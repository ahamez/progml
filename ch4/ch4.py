...
x1, x2, x3, y = np.loadtxt('../book/data/life-expectancy/life-expectancy-without-country-names.txt', skiprows=1, unpack=True)
...
w = train(X, Y, iterations=10_000_000, lr=0.00001)
